...
#     )
#     return (Set-dbHost -MACAddress $MACAddress)
# }
...
#                 Write-Host "Calling Set-dbHost..."
#                 $dbHost = Set-dbHost -MACAddress "00:11:22:33:44:55"
...
#             $dbHost = Set-dbHost -MACAddress "00:11:22:33:44:55" -Properties $props -NewProp
...
#         #     $dbHost = Set-dbHost -MACAddress "00:11:22:33:44:55" | Set-HostDetails -OS "Windows Server 2012"
...
#         #     $dbHost = Set-dbHost -MACAddress "00:11:22:33:44:55" | Set-HostDetails -OS "Windows Server 2019"
...
#         #     $dbHost = Set-dbHost -MACAddress "00:11:22:33:44:55" | Set-HostDetails -OS "Windows Server 2025"
...
#         #     $dbHost = Set-dbHost -MACAddress "00:11:22:33:44:55" | Set-HostDetails -OS "Windows Server 2016"
...
#         #         Set-dbHost -MACAddress ("00:11:22:33:44:{0:00}" -f $_) |
#         #         Set-HostBasic -IPAddress "192.168.1.100" |
#         #         Set-HostType -Type "Server" |

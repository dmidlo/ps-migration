...
# Describe 'Validate-MACAddressString Function Tests' {
...
#             $result = Validate-MACAddressString -MacAddress $Input
...
#             param ($Input)
#             { Validate-MACAddressString -MacAddress $Input } | Should -Throw -ErrorId 'InvalidMACAddressFormat'
#         }
#     }
...
#             $result = $inputMacs | Validate-MACAddressString
...
#             { Validate-MACAddressString -MacAddress $null } | Should -Throw -ErrorId 'InvalidMACAddressFormat'
#             { Validate-MACAddressString -MacAddress '' } | Should -Throw -ErrorId 'InvalidMACAddressFormat'
#         }
#     }
...
#             { Validate-MACAddressString -MacAddress 123456789012 } | Should -Throw -ErrorId 'InvalidMACAddressFormat'
#             { Validate-MACAddressString -MacAddress @(0x00, 0x1A, 0x2B, 0x3C, 0x4D, 0x5E) } | Should -Throw -ErrorId 'InvalidMACAddressFormat'
#         }
#     }
# }

...
Describe "Integration Tests for Initialize-LiteDbDatabase" {
    ...
    Context "Database creation and connection string" {
        It "Initialize-LiteDbDatabase TC01: should create a new database file and return a valid connection  with expected properties" -Tag 'active' {
            # Arragne: Run the initialization
            $dbConnection = Initialize-LiteDbDatabase -DBPath $dbPath -connectionString $connectionString
        ...
        It "Initialize-LiteDbDatabase TC02: should update UTC_DATE pragma from false to true to force UTC" -Tag 'active' {
            ...
            # Call Initialize-LiteDbDatabase to ensure application requirement of UTC_DATE standard output instead of local
            Initialize-LiteDbDatabase -connectionString $connectionString

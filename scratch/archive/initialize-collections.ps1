...
#     Out-PodeHost -InputObject $Database
    ...
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Temp' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true },
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'RecycleBin' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    ...
    # Organizations
    ###############################################################################
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Organizations' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Regions' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Campuses' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Sites' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Floors' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Areas' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Rooms' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Racks' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Panels' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Channels' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Circuits' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Providers' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )

    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Components' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )

    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Chassis' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    ###############################################################################
    # HOSTS
    ###############################################################################
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Modules' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Database $Database -CollectionName 'Interfaces' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    #     [PSCustomObject]@{ Field="Guid"; Unique=$false}
    # )
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'IPv4Addresses' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'NetworkNames' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    ...
    # DOMAINS - FSMORoles
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'FSMORoles' -Indexes @( 
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    ...
    # DOMAINS - Forests
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'Forests' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    ...
    # DOMAINS
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'Domains' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    ...
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'DomainTrusts' -Indexes @( 
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    ...
    # TENANTS
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'Tenants' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $tenantData = @{
    ...
    # USERS
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'Users' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $userData = @{
    ...
    # GROUPS
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'Groups' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $groupData = @{
    ...
    # MIGRATION BATCHES
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'MigrationBatches' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $batchData = @{
    ...
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'DHCP_Scopes' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $scopeData = @{
    ...
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'DHCP_Leases' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $leaseData = @{
    ...
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'DHCP_Reservations' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId';  Unique=$true }
    # )
    # Usage example:
    # $reservationData = @{
    ...
    # FILE SERVERS & SHARES
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'FileServers' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $fileServerData = @{
    ...
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'FileShares' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId';   Unique=$true }
    # )
    # Usage example:
    # $shareData = @{
    ...
    # GROUP POLICY
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'GroupPolicy' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $gpoData = @{
    ...
    # DRIVE MAPPINGS
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'DriveMappings' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $driveMapData = @{
    ...
    # PROFILE MIGRATIONS
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'ProfileMigrations' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $profileMigData = @{
    ...
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'FullMeshMigrations' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $fullMeshData = @{
    ...
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'Mailflow' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $mailflowData = @{
    ...
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'MailSecurityAppliances' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $applianceData = @{
    ...
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'SmartConnectors' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $connectorData = @{
    ...
    # MIGRATION WORKFLOWS
    ###############################################################################
    # Initialize-LiteDbCollection -Connection $Connection -CollectionName 'MigrationWorkflows' -Indexes @(
    #     [PSCustomObject]@{ Field='VersionId'; Unique=$true }
    # )
    # Usage example:
    # $workflowData = @{
